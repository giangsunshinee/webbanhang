...
<main>
    ...
    <div class="area-bg" data-background="uploads/bg/{{ $topBanner->image }}">
        ...
        <!-- banner-area -->
        <section class="banner-area banner-bg tg-motion-effects" data-background="uploads/banner/banner_bg.jfif">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-content">
                            <h1 class="title wow fadeInUp" data-wow-delay=".2s">{{ $topBanner->name }}</h1>
                            <span class="sub-title wow fadeInUp" data-wow-delay=".4s">Sneaker Shop</span>
                    ...
                    <div class="team-item-wrap">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="features-item tg-motion-effects">
                                    <div class="features-content">
                                        <span>{{$op->cat->name}}</span>
                                        <h4 class="title"><a href="#">{{$op->name}}</a></h4>
                                        <div class="favorite-action">
                                            @if(auth('cus')->check())
                                            @if($op->favorited)
                                            <a title="Bỏ thích" onclick="return confirm('Bạn có muốn bỏ thích không')" href="{{ route('home.favorite', $op->id) }}"><i class="fas fa-heart"></i></a>
                                            @else
                                            <a title="Yêu thích" href="{{ route('home.favorite',$op->id) }}"><i class="far fa-heart"></i></a>
                                            @endif

                                            <a title="Thêm vòa giỏ hàng" href="{{route('cart.add',$op->id )}}"><i class="fa fa-shopping-cart"></i></a>
                                        ...
                                        @if($np->sale_price > 0)
                                        <span><s>${{number_format($op->price)}}</s></span>
                                        <span class="price">${{number_format($op->sale_price)}}</span>
                                        @else
                                        <span class="price">${{number_format($op->price)}}</span>
                                        @endif
                                    </div>
                                    <div class="features-img">
                                        <img src="uploads/product/{{$op->image}}" alt="">
                                        <div class="features-shape">
                                            <img src="uploads/images/features_shape.png" alt="" class="tg-motion-effects4">
                                        </div>
                                    </div>
