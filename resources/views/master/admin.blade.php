...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="ad_assets/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>ADMIN BEMET</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-th"></i> <span>Account</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ route('account.index') }}"><i class="fa fa-circle-o"></i> Admin</a></li>
            <li><a href="{{ route('account2.index') }}"><i class="fa fa-circle-o"></i> Customer</a></li>
          </ul>
        </li>
