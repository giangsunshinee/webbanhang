                        ...
                        <div class="header-top-left">
                            <ul class="list-wrap">
                                <li class="header-location">
                                    ...
                                    11 - Thống Nhất - Hoài Đức - Hà Nội
                                </li>
                                <li>
                                    <i class="fas fa-envelope"></i>
                                    <a href="mailto:giangsunshinee@gmail.com">giangsunshinee@gmail.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-4">
                        <div class="header-top-right">
                            <div class="header-top-menu">
                                <ul class="list-wrap">
                                    @if(auth('cus')->check())
                                    <a href="{{ route('account.profile') }}">{{ auth('cus')->user()->name }}</a>
                            ...
                            <nav class="menu-nav">
                                ...
                                <div class="header-action d-none d-md-block">
                                    <ul class="list-wrap">
                                        ...
                                        <li class="header-btn"><a href="tel:0123456789" class="btn">0869311893</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="footer-widget">
                                ...
                                <div class="footer-contact">
                                    <ul class="list-wrap">
                                        <li>11 - Thống Nhất - Dương Liễu- Hoài Đức - Hà Nội</li>
                                        <li><a href="tel:0123456789">0869311893</a></li>
                                        <li><a href="mailto:info@bemet.com">giangsunshinee@gmail.com</a></li>
                                    </ul>
                                </div>
