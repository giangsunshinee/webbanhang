...
use App\Http\Controllers\admin\AccoutCustomerController;
...
Route::group(['prefix' => 'admin','middleware'=>'auth'], function() {
    ...
    Route::resource('account', AccoutAdminController::class);
    Route::resource('account2', AccoutCustomerController::class);
