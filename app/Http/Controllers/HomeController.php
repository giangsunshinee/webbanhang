...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $olds_products = Product::orderBy('created_at', 'ASC')->limit(3)->get();
        ...
        // dd ($news_products);
        return view('home.index', compact('topBanner', 'gallerys', 'news_products', 'sale_products', 'feature_products', 'olds_products'));
    }
